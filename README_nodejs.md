# All The Beans - Node.js + Express Backend

A prototype-level e-commerce application built with React frontend and Node.js + Express backend.
...
Update `client/client_beans/.env` to point to Node.js backend:
